...
* `gen_image_ui`
  ...
  - Involved: Next.js, TypeScript, TailwindCSS, Python, FastAPI, LangChain, SQLite and Docker
...
* DumbDisplay Android App
  ...
  - Involved: Android SDK and Kotlin
...
* DumbDisplay MicroPython Library
  ...
  - Involved: MicroPython and Python 3
...
* A Calculator App
  ...
  - Involved: Jetpack Compose, Kotlin and JavaScript (WASM)
...
* A Weather Clock
  ...
  - Involved: Microcontrollers (ESP32 / Raspberry Pi Pico), Arduino SDK and C/C++
